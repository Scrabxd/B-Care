...
import { Chart, registerables, CategoryScale, LinearScale, BarController, BarElement, BarControllerChartOptions, ChartOptions} from 'chart.js';
        ...
        const options: ChartOptions<'bar'> = {
          ...
          plugins: {
            ...
            datalabels: {
              ...
              formatter: (value: any, context: any) => value, // Display the value of each bar as the label
            },
          },
          scales: {
            x: {
