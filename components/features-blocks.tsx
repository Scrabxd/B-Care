        ...
        <div className="py-6 md:py-10">
          ...
          <div className="max-w-auto grid gap-6 md:grid-cols-4">
            ...
            <div className="md:col-span-2 relative flex flex-col gap-6">
              ...
              <div className="h-12 relative flex flex-col items-end">
                <a className="btn text-white w-auto mb-4 sm:w-auto sm:mb-0 shadow-xl hover:bg-[#552CB3] bg-[#7655C1]" href="#team-section">Meet our Team</a>
              </div>
            </div>
