        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200 ">
          ...
          <div className="sm:col-span-6 md:col-span-5 lg:col-span-3">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="#header" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Home</a>
              </li>
              <li className="mb-2">
                <a href="#stats" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Statistics</a>
              </li>
              <li className="mb-2">
                <a href="#AboutUs" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">About us</a>
              </li>
              <li className="mb-2">
                <a href="#testimonials" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Testimonials</a>
              </li>
              <li className="mb-2">
                <a href="#team-section" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Meet the team</a>
              </li>
              <li className="mb-2">
                <a href="#FAQ" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">FAQs</a>
              </li>
            </ul>
          </div>
