import assetTeam from '../assets/images/Oncologist.jpeg'
    ...
    <section id='AboutUs' className="relative">
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="py-6 md:py-10">
          ...
          {/* Section header */}
          <div className="flex justify-center text-center pb-4 md:pb-4">
          ...
          {/* Items */}
          <div className="max-w-auto grid gap-6 md:grid-cols-4 mx-2">
            <div className="md:col-span-2 grid gap-6 md:grid-cols-2">
              {/* 1st item */}
              <div className="relative flex flex-col items-start p-6 bg-white rounded shadow-xl">
                <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                  <g fill="#ffffff" fillRule="evenodd">
                    <rect className="fill-current" style={{color:'#34A5AB'}} width="64" height="64" rx="32" />
              ...
              <div className="relative flex flex-col items-start p-6 bg-white rounded shadow-xl">
                ...
                <ul className="list-inside text-gray-600 text-start ">
                  <li>• Embracing cutting-edge technologies and methodologies for better cancer care.</li>
                  <li>• Staying ahead in healthcare innovation.</li>
                  <li>• Driving continuous improvement in patient care.</li>
                </ul>
              </div>
            ...
            <div className="md:col-span-2 relative flex flex-col gap-6">
              ...
              <div className="h-full w-full relative md:inline-flex flex-col bg-white rounded shadow-xl hidden">
                <img src={ assetTeam } alt="asset-teamwork" className="rounded object-cover h-full w-full"/>
              </div>
