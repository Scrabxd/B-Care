...
export const Card = ({ asset, name, content, linkedin }) => (
    <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
        <div className="h-48 w-48 relative inline-flex flex-col bg-white rounded shadow-md -mt-1 mb-2">
            <img className="team-image object-cover h-full w-full" src={asset} alt="Test" />
        </div>
        <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 text-gray-900">{name}</h4>
        <p className="text-gray-600 text-center mb-1">{content}</p>
        <a href={linkedin} target='_blank' className='text-[#0288d1] h-auto w-auto hover:text-[#076fa3]'>
            <TiSocialLinkedinCircular className='w-12 h-12'/>
