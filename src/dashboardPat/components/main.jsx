                ...
                <div className='flex flex-col w-full h-1/3 bg-[#34A5ABB3] rounded-3xl text-white shadow-xl px-4 py-4 items-center justify-center'>
                    ...
                    <div className='flex w-full h-auto justify-around'>
                        <div className='flex flex-col w-full h-full pl-4'>
                            <h2 className='text-sm sm:text-base md:text-xl'>1.-Capecitabine</h2>
                            <h2 className='text-sm sm:text-base md:text-xl'>2.-Oxaliplatin</h2>
                            <h2 className='text-sm sm:text-base md:text-xl'>3.-Irinotecan</h2>
                            <h2 className='text-sm sm:text-base md:text-xl'>4.-Regorafenib</h2>
                        </div>
